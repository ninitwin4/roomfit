...
- **Stretch (not Day 30 commitments):** roommate-takeover, LLM explanations.
...
## Week 1 — detail (two sessions, ~4 hrs)
...
**Week 1 is done:** enter prefs locally → see ranked seed rooms with per-factor
reasons. ✅
...
## Week 2 / Session A — Supabase, auth & deploy — SCAFFOLDED
...
- [ ] Run the runbook: Supabase project → deploy → live URL → send to a tester
